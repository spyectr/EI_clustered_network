...
function [all_firings, PlotData]=simulation(ParamsRun)


Theta=ParamsRun.Theta; Sim=ParamsRun.Sim; 
Mu=ParamsRun.Mu; J=ParamsRun.J; N_e=ParamsRun.N_e; N_i=ParamsRun.N_i; p=ParamsRun.p; He=ParamsRun.He;
...
mu=Mu; % mu is an (N_e+N_i)-th array
%----------------
% SYNAPTIC FILTER
%----------------
